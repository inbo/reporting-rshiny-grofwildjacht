...
RUN R -q -e "options(warn = 2); remotes::install_cran(c('sf', 'dplyr', 'plyr', 'reshape2', 'mgcv', 'stringr', 'leaflet', 'flexdashboard', 'testthat', 'shinyjs', 'data.table', 'tinytex', 'tidyr', 'tidyselect', 'kableExtra', 'webshot2', 'slickR', 'ggplot2', 'ggforce'))"
