...
app %>%
  ...
  mutate(geslacht_comp = fct_reorder(geslacht_comp, ord2)) %>%
  ggplot(aes(x = afschotjaar,
             fill = leeftijd_comp:geslacht_comp)) +
  geom_bar() +
  labs(x = "Jaar",
       y = "Aantal geschoten everzwijnen",
       fill = "Type") +
  ...
  scale_fill_discrete(labels = c("Vrouwelijke frisling", "Mannelijke frisling", "Onbekende frisling",
                               "Vrouwelijke overloper", "Mannelijke overloper", "Onbekende overloper",
                               "Vrouwelijke adult", "Mannelijke adult", "Onbekende adult",
                               "Vrouwelijk, leeftijd onbekend", "Mannelijk, leeftijd onbekend", "Onbekend")) +
