...
#					toekenningsData = reactive(toekenningsData))
            ...
            results$typesGender <- reactive({
                        ...
                        list(
                                "Kits" = c("Bokkits", "Geitkits", "Reekits"),
                                "Jongvolwassen" = c("Jaarlingbok", "Smalree"),
                                "Volwassen" = c("Reebok", "Reegeit")
                        )
            ...
            results$typesDefaultGender <- reactive({
                        ...
                        grep("kits", unlist(results$typesGender()), value = TRUE)
            ...
            results$typesFemale <- reactive({
                        ...
                        types <- levels(ecoData$type_comp)
                        types[!types %in% c("", "Bokkits", "Geitkits", "Reekits", "Jaarlingbok", "Reebok")]
