...
# Plot
if (is(dash_results[[paste0("dash_", id)]]()$plot, "leaflet")) {
  # leaflet
  tmpFile <- tempfile(fileext = ".html")
  htmlwidgets::saveWidget(dash_results[[paste0("dash_", id)]]()$plot, file = tmpFile, selfcontained = FALSE)
  webshot::webshot(url = tmpFile, vwidth = 1000, vheight = 500, cliprect = "viewport")
} else {
  # plotly
  tmp <- plotlyReport(dash_results[[paste0("dash_", id)]]()$plot)
