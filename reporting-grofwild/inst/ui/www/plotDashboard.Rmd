...
```{r results = if (!is.null(params$table) && is(params$table, "datatables")) "markup" else "asis"}  
tryCatch({
    ...
    } else if (is(params$table, "datatables")){
      # DT
      # alternatives: https://stackoverflow.com/a/64727692
      # kable(params$data)
      params$table
