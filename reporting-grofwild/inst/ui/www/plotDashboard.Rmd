...
# Title
myTitle <- names(results[[paste0("dash_titles", section)]]())[
...
```
```{r, echo = FALSE, dev = if (is(results[[paste0("dash_", id)]]()$table, "datatables")) "png", results = "asis"}  
# Plot
...
} else if (is(results[[paste0("dash_", id)]]()$table, "datatables")){
  # DT
  results[[paste0("dash_", id)]]()$table
} else {
  # plotly
  tmp <- plotlyReport(results[[paste0("dash_", id)]]()$plot)
