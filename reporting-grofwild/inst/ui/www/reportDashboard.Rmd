...
if ("F16_1" %in% results$dash_showPopulatie()) {
  ...
  print(HTML(uiText[uiText$plotFunction == "F16_1", "dash"]))
...
if ("F17_1" %in% results$dash_showPopulatie()) {
  ...
  print(HTML(uiText[uiText$plotFunction == "F17_1", "dash"]))
  tmpFile <- tempfile(fileext = ".html")
...
if ("F17_4" %in% results$dash_showPopulatie()) {
  ...
  print(HTML(uiText[uiText$plotFunction == "F17_4", "dash"]))
  tmpFile <- tempfile(fileext = ".html")
...
if ("F18_1" %in% results$dash_showPopulatie()) {
  ...
  print(HTML(uiText[uiText$plotFunction == "F18_1", "dash"]))
...
if ("F04_3" %in% results$dash_showJacht()) {
  cat("##", names(results$dash_jachtTitles()[results$dash_jachtTitles() == "F04_3"]), "\n\n")
  print(HTML(uiText[uiText$plotFunction == "F04_3", "dash"]))
  results$dash_F04_3()$plot %>%
    config(displayModeBar = FALSE)
}

if ("F05_1" %in% results$dash_showJacht()) {
  cat("##", names(results$dash_jachtTitles()[results$dash_jachtTitles() == "F05_1"]), "\n\n")
  print(HTML(uiText[uiText$plotFunction == "F05_1", "dash"]))
...
if ("F05_2" %in% results$dash_showJacht()) {
  ...
  print(HTML(uiText[uiText$plotFunction == "F05_2", "dash"]))
...
if ("F06_1" %in% results$dash_showSchade()) {
  ...
  print(HTML(uiText[uiText$plotFunction == "F06_1", "dash"]))
  tmpFile <- tempfile(fileext = ".html")
...
if ("F07_1" %in% results$dash_showSchade()) {
  ...
  print(HTML(uiText[uiText$plotFunction == "F07_1", "dash"]))
...
if ("F09_2" %in% results$dash_showSchade()) {
  ...
  print(HTML(uiText[uiText$plotFunction == "F09_2", "dash"]))
...
if ("F07_3" %in% results$dash_showSchade()) {
  ...
  print(HTML(uiText[uiText$plotFunction == "F07_3", "dash"]))
...
if ("F12_1" %in% results$dash_showMaatschappij()) {
  ...
  print(HTML(uiText[uiText$plotFunction == "F12_1", "dash"]))
...
if ("F14_1" %in% results$dash_showMaatschappij()) {
  ...
  print(HTML(uiText[uiText$plotFunction == "F14_1", "dash"]))
...
if ("F14_2" %in% results$dash_showMaatschappij()) {
  ...
  print(HTML(uiText[uiText$plotFunction == "F14_2", "dash"]))
...
if ("F14_3" %in% results$dash_showMaatschappij()) {
  ...
  print(HTML(uiText[uiText$plotFunction == "F14_3", "dash"]))
  tmp <- results$dash_F14_3()$plot %>%
    config(displayModeBar = FALSE)
  tmp$height <- "1200px"
  tmp$width <- "900px"
  tmp
...
if ("F14_4" %in% results$dash_showMaatschappij()) {
  ...
  print(HTML(uiText[uiText$plotFunction == "F14_4", "dash"]))
  tmp <- results$dash_F14_4()$plot %>%
    config(displayModeBar = FALSE)
  tmp$height <- "800px"
  tmp$width <- "900px"
  tmp
...
if ("F14_5" %in% results$dash_showMaatschappij()) {
  ...
  print(HTML(uiText[uiText$plotFunction == "F14_5", "dash"]))
  tmp <- results$dash_F14_5()$plot %>%
    config(displayModeBar = FALSE)
  tmp$height <- "1200px"
  tmp$width <- "900px"
  tmp
